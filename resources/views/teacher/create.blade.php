            ...
            <div class="col-6">
                <div class="card shadow my-5 px-2 py-4 bg-light">
                    <div class="card-title text-center mt-4">
                        <h2>CREATE NEW TEACHER ENTRY</h2>
                    </div>
                    <div class="card-body">
                      ...
                      @endif
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                              ...
                              <input name="cell" type="text" class="form-control" id="cell" value="{{ old('cell') }}">
                            </div>
                            <div class="form-group">
                              <label for="user_name">Username:</label>
                              <input name="uname" type="text" class="form-control" id="user_name" value="{{ old('uname') }}">
                            </div>
                            <div class="form-group">
                    ...
                    <hr>
                    <a href="{{ route('teacher.index') }}" class="btn btn-lg btn-outline-dark w-50 mx-auto">Return to Home</a>
                </div>
            </div>
        </div>
    </div>
